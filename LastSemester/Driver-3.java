...
class EnglishNumberToWords { // Open source object.
...
class CheckMaker{
   ...
   public void GenerateCheck(String Payee, int CheckNumber, double CheckAmount){
      ...
      "\n|-----------------------------------------------------------------------|";
       ...
       System.out.println(String.format(CheckDisplay, CheckNumber, Payee, CheckAmount, AmountAsString, SplitStr[1]));
   }
   ...
   public CheckMaker(){
      ...
      this.GenerateCheck(Payee, CheckNumber, CheckAmount);
